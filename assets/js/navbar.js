...
document.addEventListener("DOMContentLoaded", function() {
    ...
    <nav id="nav">
        ...
        <ul class="icons">
            ...
            <li><a href="https://www.linkedin.com/in/sthuthy-evangeline-8b501b76/?skipRedirect=true" class="icon brands alt fa-linkedin"><span class="label">LinkedIn</span></a></li>
